...
export const navigationItems: NavigationItem[] = [
  ...
  { id: "ipd", label: "IPD", icon: BedDouble, route: "/ipd", group: "Clinical", allowedRoles: ["Super Admin", "Hospital Admin", "Doctor", "Nurse", "Receptionist", "Billing Executive", "Pharmacist", "Management"], status: "ready" },
  {
    ...
    children: [
      ...
      { id: "icu-command-timeline", label: "Patient Timeline", route: "/icu-command-center/patients/timeline", status: "ready" },
      ...
      { id: "icu-command-trends", label: "Trends & Charts", route: "/icu-command-center/diagnostics/trends-charts", status: "ready" },
